...
export const APIS = [IFormService, IModuleService, IOrganizationService, IPostService, IResourceService, IRoleService, ISchemeService, ITestService, IUserService];
